...
def confirm_po_shortage_stock(payload: ShortageStockConfirmIn) -> dict[str, Any]:
    ...
    return {
        ...
        "items": prepared,
        "message": (
            "Stok fisik dapur dicatat sebagai koreksi gudang. Reminder akan dihitung ulang dari stok yang baru."
            if inserted
            else "Stok yang dikonfirmasi sudah sama dengan saldo aktual. Reminder dihitung ulang; ia hanya hilang bila stok benar-benar mencukupi."
        ),
    }
