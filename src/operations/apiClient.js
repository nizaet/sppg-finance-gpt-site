...
export const operationsApi = {
  ...
  getPoReminders: ({ site = "", date = "", horizonDays = 14 } = {}) => { const q = new URLSearchParams({ horizonDays: String(horizonDays) }); if (site) q.set("site", site); if (date) q.set("date", date); return request(`/v1/po-reminders?${q}`); },
